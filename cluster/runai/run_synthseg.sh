for i in {0..10}; do
  ...
  runai submit \
    ...
    --volume /nfs/project/danieltudosiu/results/journal_transformer_generative/adni/ours/:/source/ \
    --volume /nfs/home/wds20/datasets/journal_transformer_generative/synthseg_results/adni_ours/:/target/ \
