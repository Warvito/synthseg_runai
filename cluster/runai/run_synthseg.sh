for i in {0..35}; do
  ...
  runai submit \
    ...
    --volume /nfs/project/danieltudosiu/results/journal_transformer_generative/adni/real/:/source/ \
    --volume /nfs/home/wds20/datasets/journal_transformer_generative/synthseg_results/adni_real/:/target/ \
